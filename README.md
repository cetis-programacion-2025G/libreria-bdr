# Proyecto Final BDR – Librería con MySQL

## 1. Historia del problema

Una librería escolar necesita controlar sus libros y préstamos. Actualmente anota en una libreta qué libro se prestó y a quién, pero con frecuencia se pierde el control de qué libros están disponibles.
...
Crear un sistema CLI para registrar libros, usuarios y préstamos básicos.
...
Reporte de préstamos: mostrar usuario, libro, fecha de préstamo y estado.
...
- No se requiere cálculo de multas
- No se requiere control de múltiples ejemplares del mismo libro
- No se requiere búsqueda avanzada por ISBN
